...
function staticCityPlaces(cityName) {
  ...
  const staticSeedsByCity = {
    visakhapatnam: [
      ...
      ['CMR Central','shopping',17.73413,83.31816,90,'10:00','22:00'],
      ['Inorbit Mall Visakhapatnam','shopping',17.686801,83.218501,120,'11:00','21:30'],
  ...
  return seeds.map((s, i) => ({
    ...
    importanceScore: s[1] === 'food' ? 70 : s[1] === 'shopping' ? 92 : Math.max(35, 100 - i * 3),
    curated: true,
    source: 'curated_internal_city_seed',
    sourceConfidence: s[1] === 'shopping' ? 92 : 82,
    tourismRelevance: s[1] === 'food' ? 76 : s[1] === 'shopping' ? 94 : 86,
    tourismTier: s[1] === 'shopping' ? 'S' : undefined,
    officialVenue: /Inorbit Mall Visakhapatnam/i.test(s[0]),
  }));
}
