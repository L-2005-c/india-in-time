...
function scoreTransition(place, arrivalMin, state, requirements, weather, nowBase, travel, waitMinutes, memo) {
  ...
  return {
    ...
    freeFlowMinutes: travel?.freeFlowMinutes,
    trafficDelayMinutes: travel?.trafficDelayMinutes,
    etaBreakdown: travel?.etaBreakdown,
    trafficTransition: travel?.trafficTransition,
    transitionDescription: travel?.transitionDescription,
...
function buildStop(place, scored, arrivalMin, state) {
  ...
  return {
    ...
    freeFlowMinutes: scored.freeFlowMinutes ?? null,
    trafficDelayMinutes: scored.trafficDelayMinutes ?? 0,
    etaBreakdown: scored.etaBreakdown || null,
    trafficTransition: scored.trafficTransition || null,
    transitionDescription: scored.transitionDescription || null,
    ...
    crowdBadge,
    estimatedQueueMinutes: intel.crowd?.estimatedQueueMinutes ?? 0,
    queueDescriptor: intel.crowd?.queueDescriptor || null,
    weather: intel.weather,
    apparentTempC: intel.weather?.apparentTempC ?? null,
    weatherComfortBadge,
    scenicBadge,
    timePhaseBadge,
    goldenHourRating,
    ...
    transitRecommendation: intel.traffic?.transitRecommendation || null,
    rushHourActive: !!intel.traffic?.rushHourActive,
    rushLabel: intel.traffic?.rushLabel || null,
    nearbySpots,
