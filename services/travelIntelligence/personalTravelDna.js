...
const DEFAULT_TRAVEL_DNA = Object.freeze({
  ...
  rainTolerance: 40,
  ghatTolerance: 50,
  // Phase 3 Safety & Risk Declared Dimensions
  rainExposureTolerance: 40,
  heatExposureTolerance: 50,
  nightTravelTolerance: 50,
  remoteAreaTolerance: 50,
  roadComplexityTolerance: 50,
  scheduleFlexibility: 50,
  // Declared Contexts (Never Inferred - Explicitly Declared Only)
  travellingWithChildren: false,
  travellingWithElderly: false,
  mobilityConstraintDeclared: false,
  nightTravelRestricted: false,
  medicalConstraintDeclared: false,
...
function sanitizeDnaProfile(input = {}) {
  ...
  return {
    ...
    // Phase 3 Safety & Risk Declared Dimensions
    rainExposureTolerance: clamp(input.rainExposureTolerance != null ? input.rainExposureTolerance : input.rainTolerance, 0, 100, DEFAULT_TRAVEL_DNA.rainExposureTolerance),
    heatExposureTolerance: clamp(input.heatExposureTolerance != null ? input.heatExposureTolerance : input.heatTolerance, 0, 100, DEFAULT_TRAVEL_DNA.heatExposureTolerance),
    nightTravelTolerance: clamp(input.nightTravelTolerance, 0, 100, DEFAULT_TRAVEL_DNA.nightTravelTolerance),
    remoteAreaTolerance: clamp(input.remoteAreaTolerance, 0, 100, DEFAULT_TRAVEL_DNA.remoteAreaTolerance),
    roadComplexityTolerance: clamp(input.roadComplexityTolerance, 0, 100, DEFAULT_TRAVEL_DNA.roadComplexityTolerance),
    scheduleFlexibility: clamp(input.scheduleFlexibility, 0, 100, DEFAULT_TRAVEL_DNA.scheduleFlexibility),
    // Declared Contexts (Explicit declaration only — never inferred)
    travellingWithChildren: Boolean(input.travellingWithChildren),
    travellingWithElderly: Boolean(input.travellingWithElderly),
    mobilityConstraintDeclared: Boolean(input.mobilityConstraintDeclared),
    nightTravelRestricted: Boolean(input.nightTravelRestricted),
    medicalConstraintDeclared: Boolean(input.medicalConstraintDeclared),
