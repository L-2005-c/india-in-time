...
const HAZARD_TYPES = Object.freeze({
  ...
  // Landslide hierarchy (Section 18)
  LANDSLIDE: 'LANDSLIDE',
  LANDSLIDE_RISK: 'LANDSLIDE_RISK',
  LANDSLIDE_WARNING: 'LANDSLIDE_WARNING',
  ACTIVE_LANDSLIDE: 'ACTIVE_LANDSLIDE',
  ROAD_BLOCKED_BY_LANDSLIDE: 'ROAD_BLOCKED_BY_LANDSLIDE',
  // Fire hierarchy (Section 20)
  FIRE_ANOMALY: 'FIRE_ANOMALY',
  FOREST_FIRE_SIGNAL: 'FOREST_FIRE_SIGNAL',
  FOREST_FIRE: 'FOREST_FIRE',
  CONFIRMED_FIRE: 'CONFIRMED_FIRE',
  FIRE_ROUTE_IMPACT: 'FIRE_ROUTE_IMPACT',
