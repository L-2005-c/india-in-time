...
const SELECTION_REASONS = Object.freeze({
  LIVE_OBSERVATION_MATCH: 'LIVE_OBSERVATION_MATCH',
  NWP_MODEL_AVAILABLE: 'NWP_MODEL_AVAILABLE',
  MULTIPLE_PROVIDER_CONSENSUS: 'MULTIPLE_PROVIDER_CONSENSUS',
  DISAGREEMENT_PESSIMISTIC_BOUND: 'DISAGREEMENT_PESSIMISTIC_BOUND',
  FALLBACK_DIURNAL_ESTIMATE: 'FALLBACK_DIURNAL_ESTIMATE',
  FALLBACK_HISTORICAL_CLIMATOLOGY: 'FALLBACK_HISTORICAL_CLIMATOLOGY',
  TELEMETRY_UNAVAILABLE: 'TELEMETRY_UNAVAILABLE',
});

const WEATHER_CLASSIFICATIONS = Object.freeze({
...
const CANONICAL_ROAD_CIRCUITY_FACTOR = 1.42;

const WEATHER_CONSENSUS_STATES = Object.freeze({
...
module.exports = {
  ...
  HAZARD_SOURCES,
  CROWD_METHODS,
  CANONICAL_ROAD_CIRCUITY_FACTOR,
