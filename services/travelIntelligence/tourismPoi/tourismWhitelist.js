...
const VIZAG = [
  ...
  entry('Bheemili Beach', 'beach', 'A', 17.8903, 83.4545, ['bheemunipatnam beach', 'bhimili beach']),
  ...
  entry('Lawsons Bay Beach', 'beach', 'B', 17.7338, 83.3398, ["lawson's bay", 'lawson bay']),
  ...
  entry('Victory at Sea War Memorial', 'monument', 'B', 17.7187, 83.3304, ['victory at sea']),
  ...
  entry('VUDA Park', 'park', 'B', 17.7265, 83.3340, ['vuda city central park']),
