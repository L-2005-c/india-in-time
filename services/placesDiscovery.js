...
async function fetchCuratedFoodFallback(lat, lon, cityName) {
  const CITY_FOOD_SEEDS = {
    ...
    hyderabad: ['Bawarchi Restaurant', 'Paradise Biryani', 'Shah Ghouse', 'Cafe Niloufer', 'Pista House', 'Chutneys'],
    paderu: ['Bongu Kodi Bamboo Chicken Center Paderu', 'Araku Bamboo Chicken & Spice Hub', 'Paderu Arabica Coffee House', 'Madugula Halwa Center'],
    araku: ['Araku Bamboo Chicken & Spice Hub', 'Araku Coffee House', 'Bongu Kodi Bamboo Chicken Center Paderu'],
    lambasingi: ['Lambasingi Strawberry Farms & Cafe', 'Bongu Kodi Bamboo Chicken Center Paderu'],
    chennai: ['Murugan Idli Shop', 'Rayars Mess Mylapore', 'Saravana Bhavan George Town', 'Buhari Hotel Mount Road', 'Annalakshmi Restaurant'],
    madras: ['Murugan Idli Shop', 'Rayars Mess Mylapore', 'Saravana Bhavan George Town', 'Buhari Hotel Mount Road'],
    mumbai: ['Leopold Cafe', 'Bademiya', 'Britannia & Co', 'Kyani & Co', 'Mahesh Lunch Home', 'Sardar Refreshments Pav Bhaji'],
    bombay: ['Leopold Cafe', 'Bademiya', 'Britannia & Co', 'Kyani & Co'],
    kochi: ['Kashi Art Cafe', 'Kayees Rahmathulla Cafe', 'Paragon Restaurant', 'Dhe Puttu', 'Grand Pavilion'],
    cochin: ['Kashi Art Cafe', 'Kayees Rahmathulla Cafe', 'Paragon Restaurant', 'Dhe Puttu'],
  };
...
async function fetchCuratedCityFallback(lat, lon, cityName) {
  const CITY_SEEDS = {
    ...
    paderu: [
      { name: 'Vanjangi Cloud Peak (Meghala Konda)', cat: 'viewpoint', vt: 150 },
      { name: 'Borra Caves', cat: 'scenic', vt: 90 },
      { name: 'Katiki Waterfalls', cat: 'scenic', vt: 120 },
      { name: 'Araku Tribal Museum', cat: 'museum', vt: 60 },
      { name: 'Araku Coffee Museum & Café', cat: 'museum', vt: 45 },
      { name: 'Padmapuram Botanical Gardens', cat: 'park', vt: 60 },
      { name: 'Chaparai Water Cascades (Dumbriguda)', cat: 'scenic', vt: 90 },
      { name: 'Galikonda View Point', cat: 'viewpoint', vt: 45 },
      { name: 'Lambasingi Cloud & Pine Forest Trail', cat: 'scenic', vt: 120 },
      { name: 'Thajangi Reservoir Boating Lambasingi', cat: 'scenic', vt: 75 },
      { name: 'Kothapalli Waterfalls Lambasingi', cat: 'scenic', vt: 90 },
      { name: 'Sri Modakondamma Ammavari Temple', cat: 'temple', vt: 60 },
      { name: 'Modamamba Padalu Stream Spot', cat: 'scenic', vt: 45 },
      { name: 'Matsyagundam Sacred Fish Pool & Shiva Temple', cat: 'temple', vt: 75 },
      { name: 'Paderu Shaded Arabica Coffee Plantations', cat: 'scenic', vt: 60 },
    ],
    araku: [
      { name: 'Borra Caves', cat: 'scenic', vt: 90 },
      { name: 'Katiki Waterfalls', cat: 'scenic', vt: 120 },
    ...
    lambasingi: [
      ...
      { name: 'Thajangi Reservoir Boating Lambasingi', cat: 'scenic', vt: 75 },
      { name: 'Kothapalli Waterfalls Lambasingi', cat: 'scenic', vt: 90 },
      { name: 'Susan Garden Yellow Flower Fields', cat: 'scenic', vt: 45 },
    ],
    chennai: [
      { name: 'Marina Beach', cat: 'beach', vt: 90 },
      { name: 'Kapaleeshwarar Temple', cat: 'temple', vt: 60 },
      { name: 'San Thome Basilica', cat: 'temple', vt: 45 },
      { name: 'Fort St George', cat: 'heritage', vt: 75 },
      { name: 'Government Museum Chennai', cat: 'museum', vt: 90 },
      { name: 'Edward Elliot Beach (Besant Nagar)', cat: 'beach', vt: 75 },
      { name: 'Guindy National Park', cat: 'park', vt: 90 },
      { name: 'Valluvar Kottam', cat: 'monument', vt: 45 },
      { name: 'DakshinaChitra Heritage Museum', cat: 'museum', vt: 120 },
    ],
    mumbai: [
      { name: 'Gateway of India', cat: 'scenic', vt: 45 },
      { name: 'Marine Drive', cat: 'scenic', vt: 60 },
      { name: 'Chhatrapati Shivaji Maharaj Vastu Sangrahalaya', cat: 'museum', vt: 75 },
      { name: 'Elephanta Caves', cat: 'scenic', vt: 120 },
      { name: 'Siddhivinayak Temple', cat: 'temple', vt: 60 },
      { name: 'Haji Ali Dargah', cat: 'temple', vt: 60 },
      { name: 'Juhu Beach', cat: 'beach', vt: 75 },
      { name: 'Bandra Fort (Castella de Aguada)', cat: 'scenic', vt: 60 },
      { name: 'Global Vipassana Pagoda', cat: 'scenic', vt: 90 },
    ],
    kochi: [
      { name: 'Fort Kochi Beach', cat: 'beach', vt: 75 },
      { name: 'Chinese Fishing Nets', cat: 'scenic', vt: 45 },
      { name: 'Mattancherry Palace (Dutch Palace)', cat: 'scenic', vt: 60 },
      { name: 'Paradesi Synagogue Jew Town', cat: 'temple', vt: 45 },
      { name: 'St Francis Church Fort Kochi', cat: 'temple', vt: 45 },
      { name: 'Santa Cruz Cathedral Basilica', cat: 'temple', vt: 45 },
      { name: 'Marine Drive Kochi & Rainbow Bridge', cat: 'scenic', vt: 60 },
      { name: 'Hill Palace Museum Tripunithura', cat: 'scenic', vt: 90 },
      { name: 'Kumbalangi Model Eco-Tourism Village', cat: 'scenic', vt: 90 },
    ],
    vijayawada: [
